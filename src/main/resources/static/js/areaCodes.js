(function () {
    ...
    function GetAreaCodeController($scope){

        $scope.areaObj = {};

        /** 获取完整地区代码 参数：city为该城市的地区码，district为第三级的地区代码**/

        $scope.getAreaCode = function (city, district) {

            var areaCode;

            if (!$scope.DISTRICTS[city] && city)
        ...
        $scope.getAreaName = function (areaCode) {
